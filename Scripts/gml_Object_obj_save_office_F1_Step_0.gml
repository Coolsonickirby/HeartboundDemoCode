if (global.storyline_array[148] == 1)
{
    var ducks_total = 5;
    
    for (var xx = 0; xx < ducks_total; xx++)
    {
        if (global.storyline_array[142 + xx] == 1)
        {
            cur_message = 4005;
            dialog_step = 2;
            break;
                ...
                switch (dialog_step)
                {
                    case 1:
                        switch (next_step)
                        {
                            ...
                            case 3:
                                save_location(room, obj_lore.x, obj_lore.y);
                                save_game();
                                scr_sound_play(snd_save_complete, 0.15, 1, false);
                                next_step = 4;
                                cur_message = 4002;
                                question_true = 0;
                                question_asked = 0;
